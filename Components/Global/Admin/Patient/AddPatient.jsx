...
const AddPatient = ({ registerDoctors, isOpen, setIsOpen }) => {
  ...
  const [patient, setPatient] = useState({
    ...
    message: "Patient registration request",
    city: "",
  });

  useEffect(() => {
    if (registerDoctors?.length && !doctor) {
      setDoctor(registerDoctors[0]);
    }
  }, [doctor, registerDoctors]);
